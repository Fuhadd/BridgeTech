...
class _UserRequestsScreenState extends State<UserRequestsScreen> {
  ...
  getChatRooms() async {
    chatRoomsStream =
        await FirestoreRepository().getAllRequest(widget.currentUser.id!);
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: MessageAppar(
            context, 'Received Requests', widget.currentUser.imageUrl),
        body: chatRoomsList());
  }
}
